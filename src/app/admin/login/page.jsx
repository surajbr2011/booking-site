...
import { User, Mail, Lock, Loader2, AlertCircle, ChevronRight, ShieldCheck } from "lucide-react";
...
export default function AdminLoginPage() {
  ...
  const onSubmit = async (data) => {
    ...
    // Use the login function from context for real sync state
    setTimeout(() => {
    ...
    <div className="min-h-screen bg-[#020617] flex items-center justify-center p-6 relative overflow-hidden font-sans selection:bg-[#1e81b0] selection:text-white">
      ...
      >
        <div className="bg-white/[0.02] backdrop-blur-2xl rounded-[40px] shadow-[0_30px_100px_rgba(0,0,0,0.5)] p-10 md:p-14 border border-white/10">
              ...
              <div className="space-y-2">
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full h-14 bg-white/[0.03] border border-white/5 rounded-2xl pl-12 pr-6 font-bold text-white placeholder:text-gray-600 focus:outline-none focus:ring-2 focus:ring-[#1e81b0]/40 transition-all text-sm"
                  />
                </div>
          ...
          <div className="mt-12 text-center text-[9px] text-gray-700 font-bold uppercase tracking-widest border-t border-white/5 pt-8">
