          ...
          {attractions.map((attraction, i) => (
            ...
            >
              <div className="aspect-[5/4] relative overflow-hidden">
                ...
                <button 
                  onClick={() => setSelectedPhoto(attraction.img)}
                  className="absolute bottom-6 left-6 right-6 p-4 w-[calc(100%-48px)] bg-white/20 backdrop-blur-xl rounded-2xl border border-white/30 flex items-center justify-between opacity-0 group-hover:opacity-100 transition-all duration-300 hover:bg-white/30"
                >
              ...
              <div className="p-8 flex-grow flex flex-col">
                ...
                <a 
                  href={`https://maps.google.com/?q=${encodeURIComponent(attraction.name + " Goa")}`} 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="flex items-center gap-3 text-[#1e81b0] font-black text-xs uppercase tracking-[0.15em] hover:gap-5 transition-all w-fit"
                >
