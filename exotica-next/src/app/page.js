  ...
  useEffect(() => {
    api.getRooms()
      .then(res => {
        ...
        const mapped = roomList.slice(0, 6).map(r => ({
          id: r.id,
          title: r.roomName,
          type: r.roomType,
      ...
      .catch(err => console.error('Failed to fetch rooms for home:', err))
      ...
      <section className="py-20 px-6 bg-[#f8f6f0] overflow-hidden">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div className="flex flex-col items-start gap-6 pt-2">
            ...
            <button suppressHydrationWarning className="bg-[#1e81b0] hover:bg-[#15648a] text-white px-8 py-[12px] mt-2 rounded-full font-bold shadow-sm transition-colors text-[15px]">
              View More
            </button>
          </div>
        </div>
        ...
        <div className="max-w-[1000px] mx-auto flex flex-col gap-24">
          ...
          <div className="flex flex-col md:flex-row gap-10 md:gap-14 items-center">
            ...
            <div className="w-full md:w-[45%] flex flex-col gap-5 max-w-[420px]">
              ...
              <div className="mt-1">
                <button suppressHydrationWarning className="flex items-center text-[15px] font-bold text-[#2a303c] hover:text-[#1e81b0] transition-colors group">
