  ...
  useEffect(() => {
    api.getRooms()
      .then(res => {
        ...
        // Map backend fields to what RoomCard expects
            ...
            <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 sticky top-24">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="px-2">
                    <input type="range" className="w-full accent-[#1e81b0]" min="3000" max="6000" />
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center justify-between mb-8 bg-white p-4 rounded-2xl shadow-sm border border-gray-100">
              <h1 className="text-xl font-bold text-[#1e293b]">
                {isLoading ? 'Loading...' : `${filteredRooms.length} Rooms Found`}
              </h1>
            ...
            {isLoading ? (
              ...
              <div className="text-center py-20 text-gray-400 font-medium">
                No rooms found. Please check back later.
              </div>
            ) : (
